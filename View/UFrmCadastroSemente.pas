...
uses
  ...
  JvGradient, Vcl.DBCtrls, JvExMask, JvToolEdit, JvBaseEdits, JvDBControls, Classe.Semente, Classe.Sistema.Mensagens;
...
type
  TFrmCadastroSemente = class(TFrmModel1)
    ...
    BtTecnBtCancelar: TJvSpeedButton;
...
procedure TFrmCadastroSemente.EdtPesquisaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #13 then
      begin
...
procedure TFrmCadastroSemente.FormClose(Sender: TObject;
