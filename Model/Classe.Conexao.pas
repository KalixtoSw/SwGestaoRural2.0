...
type
  TDMPrincipal = class(TDataModule)
    ...
    DsTbTalhao: TDataSource;
    TbTalhao: TFDTable;
    TbTalhaotbl_idTalhao: TFDAutoIncField;
    TbTalhaotbl_dtcriacao: TSQLTimeStampField;
    TbTalhaotbl_AreaTalhao: TFMTBCDField;
    TbTalhaotbl_TipoTalhao: TStringField;
    TbTalhaotbl_descricao: TStringField;
    TbTalhaotbl_latitude: TFMTBCDField;
    TbTalhaotbl_longitude: TFMTBCDField;
    TbTalhaotbl_linkMapa: TStringField;
    TbTalhaopr_idPropriedadeRural: TLongWordField;
    TbTalhaotbl_status: TStringField;
    TbTalhaotbl_checkbox: TIntegerField;
    TbTalhaoCheck: TIntegerField;
    DsTbPlantio_Talhao: TDataSource;
    TbPlantio_Talhao: TFDTable;
    TbPlantio_Talhaopltl_id: TFDAutoIncField;
    TbPlantio_TalhaopltlDescricao: TStringField;
    TbPlantio_Talhaoplt_id: TIntegerField;
    TbPlantio_Talhaotbl_idTalhao: TIntegerField;
    ...
    DsTbPlantio_Insumo: TDataSource;
    TbPlantio_Insumo: TFDTable;
    DsTbProdutoExt: TDataSource;
    TbProdutoExt: TFDTable;
    TbProdutoExtprxid: TFDAutoIncField;
    TbProdutoExtprd_idproduto: TIntegerField;
    TbProdutoExtprd_nome: TStringField;
    TbProdutoExtprde_Id: TIntegerField;
    TbProdutoExtprde_descricao: TStringField;
    TbProdutoExtprx_NomeComercial: TStringField;
    TbPlantio_Insumoplis_id: TFDAutoIncField;
    TbPlantio_Insumoplis_dtcriacao: TSQLTimeStampField;
    TbPlantio_Insumoplt_id: TIntegerField;
    TbPlantio_Insumoplt_qtde: TBCDField;
    TbPlantio_Insumoprxid: TIntegerField;
    TbPlantio_InsumoProduto: TStringField;
    QryCtrlEstProdutoprxid: TIntegerField;
    QryCtrlEstProdutoprd_idproduto: TIntegerField;
    QryCtrlEstProdutoprde_Id: TIntegerField;
    QryCtrlEstProdutoprx_NomeComercial: TStringField;
    QryCtrlEstProdutoSaldoEstoque: TFMTBCDField;
    ...
    TbMovimentacaonf_id: TIntegerField;
