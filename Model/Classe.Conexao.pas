...
type
  TDMPrincipal = class(TDataModule)
    ...
    TbPlantio_Insumoprde_Id: TIntegerField;
    ...
    QryCtrlEstProdutoprd_nome: TStringField;
    QryCtrlEstProdutoEmbalagem: TStringField;
    QryCtrlEstProdutoprd_fabricante: TStringField;
    QryCtrlEstProdutoprd_tipo: TStringField;
    QryCtrlEstProdutoprd_status: TStringField;
    QryCtrlEstProdutoProduto_Embalagem: TStringField;
    QryCtrlEstProdutomov_tipo: TStringField;
    QryCtrlEstProdutoQTD_UNIT: TFMTBCDField;
    QryCtrlEstProdutoCtrlEstoque: TFMTBCDField;
    QryCtrlEstProdutoPreco_Medio: TFMTBCDField;
    QryCtrlEstProdutoValor_Geral: TFMTBCDField;
